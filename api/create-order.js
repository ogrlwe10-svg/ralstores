...
const PRODUCTS = [
  { id: 1,  name: 'Disney+',                   price: 2    },
  { id: 2,  name: 'Paramount+',                price: 2    },
  { id: 3,  name: 'Netflix Lifetime',          price: 2    },
  ...
  { id: 10, name: 'Spotify Lifetime',          price: 4    },
  { id: 11, name: 'Spotify Key Lifetime',      price: 6    },
  { id: 12, name: 'Crunchyroll MEGA FAN Lifetime',      price: 3    },
  { id: 13, name: 'Duolingo Lifetime',         price: 1.50    },
  { id: 14, name: 'NBA Lifetime',              price: 1.50    },
  { id: 15, name: 'TikTok 1K Followers',       price: 5    },
  { id: 16, name: 'TikTok 10K Followers',      price: 21   },
  { id: 17, name: 'TikTok 20K Followers',      price: 35   },
  { id: 18, name: 'Instagram 1K Followers',    price: 5    },
  { id: 19, name: 'Instagram 5K Followers',    price: 12   },
  { id: 20, name: 'YouTube Lifetime',          price: 2.50    },
  { id: 21, name: 'Twitch 100 Followers',      price: 1    },
  { id: 22, name: 'Twitch 500 Followers',      price: 2.50   },
  { id: 23, name: 'Twitch 2000 Followers',     price: 5   },
  { id: 24, name: 'Twitch 5000 Followers',     price: 8.75   },
  { id: 25, name: 'Twitch 10000 Followers',    price: 15   },
  { id: 26, name: 'ChatGPT Accounts',          price: 3.50    },
  { id: 27, name: 'Gemini Pro Accounts',       price: 2.50    },
  { id: 28, name: 'Movistar+ Lifetime',        price: 2.50    },
  { id: 29, name: 'CapCut Pro Lifetime',       price: 2    },
  { id: 30, name: 'Filmora Lifetime',          price: 1.85    },
  { id: 31, name: 'NordVPN Lifetime',          price: 3    },
  { id: 32, name: 'HotSpot Shield VPN 1 Year', price: 4.50    },
  { id: 33, name: 'TunnelBear',                price: 2.80    },
  { id: 34, name: 'IPVanish 1 Year',           price: 2.50    },
  { id: 35, name: 'PureVPN',                   price: 3.90    },
  { id: 36, name: 'Mullvad Lifetime',          price: 8.50    },
];
